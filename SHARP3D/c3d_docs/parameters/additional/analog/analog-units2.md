...
The parameters in these serie (i.e. UNIT2, UNIT3, etc) are an array of 255 additional [ANALOG:UNIT](../../required/analog/analog-unit.md) values. These parameters are synchronized with the corresponding nalog channels. An individual [UNIT](../../required/analog/analog-unit.md) parameter is
required for every analog channel supported by the C3D file. Refer to the page on [ANALOG:UNIT](../../required/analog/analog-unit.md) for more information.
