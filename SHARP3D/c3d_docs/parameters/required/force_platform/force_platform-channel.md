...
> This is FORCE_PLATFORM:CHANNEL and not FORCE_PLATFORM:CHANNELS. The typo is made in C3D User Guide and therefore all the C3D files, as it is what is expected.
