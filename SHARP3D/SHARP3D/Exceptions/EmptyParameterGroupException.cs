...
{
    /// <summary>
    /// Exception thrown when an C3D Parameter Group is empty.
    /// </summary>
    public class EmptyParameterGroupException : ArgumentException
    {
        ...
        public EmptyParameterGroupException(string message)
            : base(message)
        {
        }
        ...
        /// specified.</param>
        public EmptyParameterGroupException(string message, Exception innerException)
