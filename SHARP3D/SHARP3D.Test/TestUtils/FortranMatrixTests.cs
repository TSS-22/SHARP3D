...
namespace SHARP3D.Test.Utils
{
    public class FortranMatrixTests
    {
        ...
        public static IEnumerable<object[]> ScalarVecToMatTest =>
            new List<object[]>
        {
            new object[] {new char[]{'@'}, new byte[] { 64 }, DataType.CHAR},
            new object[] { new byte[] { 80 }, new byte[] { 80 }, DataType.BYTE},
            new object[] { new int[]{ 12345 }, new byte[]{ 0x39, 0x30}, DataType.INT16},
            new object[] { new float[] { 55.040f }, new byte[] { 0xF6, 0x28, 0x5C, 0x42 }, DataType.FLOAT32},
        };
        [Theory]
        [MemberData(nameof(ScalarVecToMatTest))]
        public void ScalarVecToMat_Test(Array expectedValue, byte[] byteValue, DataType dataLength)
        {
            Array data;
        ...
        public static IEnumerable<object[]> Vec1DToMatData=>
            new List<object[]>
        {
            new object[] {new char[]{'P', 'Q', 'R', 'S', 'T', 'U' }, new byte[] { 0x50,0x51,0x52,0x53,0x54,0x55 }, DataType.CHAR},
            new object[] { new byte[] { 128,129,130,131,132,133}, new byte[] { 0x80, 0x81, 0x82, 0x83, 0x84, 0x85 }, DataType.BYTE},
            new object[] { new int[]{ 123, 124, 125, 126, 127, 128 }, new byte[]{ 0x7B, 0x00, 0x7C, 0x00, 0x7D, 0x00, 0x7E, 0x00, 0x7F, 0x00, 0x80, 0x00, }, DataType.INT16},
            new object[] { new float[] { 123.5678f, 124.5678f, 125.5678f, 126.5678f, 127.5678f, 128.5678f }, new byte[] { 0xB7, 0x22, 0xF7, 0x42, 0xB7, 0x22, 0xF9, 0x42, 0xB7, 0x22, 0xFB, 0x42, 0xB7, 0x22, 0xFD, 0x42, 0xB7, 0x22, 0xFF, 0x42, 0x5B, 0x91, 0x00, 0x43, }, DataType.FLOAT32},
        };
        [Theory]
        [MemberData(nameof(Vec1DToMatData))]
        public void Vec1DToMat_Test(Array expectedValue, byte[] byteValue, DataType dataLength)
        {
            Array data;
